...
figure(1), subplot(2, 1, 1), plot(time, data); axis('tight'); title('Dziedzina czasu');
...
figure(3), plot(x, Yemp, kol1, v, yo, 'r',x,E,'k', v, z, 'g'); hold on;
%input(' co dalej ?? ');
