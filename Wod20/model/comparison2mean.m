...
xlabel(sprintf('Ldanych=%d, œrednia z 7-miu lat, [1 rok]', Ldanych)); ylabel(['Temperatura wody [' char(176) 'C]']);
axis('tight'); title('Porównanie: œrednia temperatur z 7-miu lat/do krzywej trendu regresji'); hold off;
