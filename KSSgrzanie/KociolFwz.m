...
% Fw=qFw/(cw*(Twg-Twz))=Fwz*(rog/roz*Twg-Twz)/(Twg-Twz); Fwz - sta³a wartoœæ przeplywu wody zimnej 
% Fw=Fwz*(rog/roz*Twg-Twz)/(Twg-Twz); 
% roz=ro0/(1+wExp*(Twz-20)); rog=ro0/(1+wExp*(Twg-20));
% Twg=(Twz-T*(1-exp(-Kkal/(Fw*cw)))/exp(-Kkal/(Fw*cw));% ................ Szukamy Twg, które przy ste³êj Fwz i Twz daj¹ zadan¹ qzap:
