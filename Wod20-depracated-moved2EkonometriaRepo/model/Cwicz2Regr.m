...
figure(22), plot([1:length(data)],vi(1:end),[1 length(data)],[mean(data)/std(data) mean(data)/std(data)],'r--')
title('zmiennoœæ danych opisuj¹cych (œredna/odchylenie stanadrdowe)'); 
